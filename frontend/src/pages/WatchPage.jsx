...
import {formReleaseDate} from "../utils/DateFunction";
    ...
    return  <div className="bg-black min-h-screen text-white">
        <div className="mx-auto container px-4 py-8 h-full">
            ...
            <div className="aspect-video mb-8 sm:px-10 md:px-32">
                ...
                {trailers?.length ===0 &&(
                    <h2 className="text-2xl text-center mt-5">No trailers available for{""}
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-20">
                <div className="mb-4 md:mb-0">
                         ...
                         <p className="mt-2 text-lg">
                            {formReleaseDate(content?.release_date || content?.first_air_date)} |{""}
                            {content?.adult ?(
            ...
            <ChevronLeft
            className="absolute top-1/2 -translate-y-1/2 left-2 w-8 h-8 opacity-0 group-hover:opacity-100 transition-all duration-300 cursor-pointer bg-red-600  text-white rounded-full" onClick={scrollLeft}
            />

        
        
            <ChevronRight size={24} 
            className="absolute top-1/2 -translate-y-1/2 right-2 w-8 h-8 opacity-0 group-hover:opacity-100 transition-all duration-300 cursor-pointer bg-red-600  text-white rounded-full" onClick={scrollRight}/>
