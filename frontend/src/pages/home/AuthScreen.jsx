  ...
  return (
    ...
    <div className='flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto'>
      ...
      <input type='email'
            ...
            <button className='bg-red-600 text-xl lg:text-2xl px-6 py-1 rounded flex justify-center items-center'>
              Get Started
   ...
   <div className='h-2 w-full bg-[#232323]' aria-hidden='true'/>
    <div className='py-10 bg-black text-white'>
      <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-4'>
    ...
    <div className='py-10 bg-black text-white'>
      <div className='flex max-6xl mx-auto items-center justify-center flex-col-reverse md:flex-row px-4 md:px-2'>
        ...
        <div className='flex-1 text-center md:text-left'>
          ...
          <p className='text-lg md:text-xl'>
           Send kids on adventures with their favorite character in a space made just  for them-free with your membership.
          </p>
        </div>
        </div>
