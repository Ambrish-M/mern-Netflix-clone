    ...
    <div className="bg-black min-h-screen text-white">
        ...
        <div className="container mx-auto px-4 py-8">
            <div className="flex justify-center gap-3 mb-4">
                <button className={`py-2 px-4 rounded ${activeTab ==="movie" ?"bg-red-600 hover:bg-red-700" :"bg-gray-800" }`}
                 onClick={()=>handleTabClick("movie")}>
                    Movies

                </button>
                <button className={`py-2 px-4 rounded ${activeTab ==="tv" ?"bg-red-600 hover:bg-red-700" :"bg-gray-800" }`}
                 onClick={()=>handleTabClick("tv")}>
                    TV Shows

                </button>
                <button className={`py-2 px-4 rounded ${activeTab ==="person" ?"bg-red-600 hover:bg-red-700" :"bg-gray-800" }`}
